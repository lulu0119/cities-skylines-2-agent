...
- Empty land: connect a road from the highway, then choose unlocked power, water and sewage prefabs with list_prefabs and place them with x/z/radius. Non-wind power needs a transformer and a hand-built high-voltage cable; read utility-networks. Use local_map at the site before choosing an expansion direction or when shoreline/slope evidence matters; its LOCAL_MAP frame, regions, sectors and road topology are compact spatial evidence, while the write tools remain responsible for native validation.
