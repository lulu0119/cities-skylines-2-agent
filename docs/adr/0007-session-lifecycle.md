...
The Agent is a mayor of the current save, not a cloud workspace. Switching cities clears the session. Restoring a save into a continuing session, and multiple concurrent sessions, remain long-term goals.
